        ...
        for j in range(n_replicates):
            try:
                ...
                new_params = Simulation_Parameters(
                    ...
                    forward_model_weights=jnp.array([10.0, maxent_params[j], 1], dtype=jnp.float32),
...
def main():
    ...
    base_output_dir = os.path.join(base_output_dir, f"{protein}/jaxENT/MSE10_AdamW_MAD1")
