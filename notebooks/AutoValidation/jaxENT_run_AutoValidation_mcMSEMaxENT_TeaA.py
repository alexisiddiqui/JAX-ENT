...
from jaxent.src.opt.losses import hdx_uptake_mean_centred_MSE_loss, maxent_convexKL_loss
...
if __name__ == "__main__":
    ...
    regularisation_scales = [1e0, 1e-1, 1e-3, 1e-5, 1e-7, 1e-9, 1e-11]
    regularisation_scales = [1e-2, 1e-4]
