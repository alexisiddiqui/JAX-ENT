...
from jaxent.src.opt.losses import frame_weight_consistency_loss, hdx_uptake_mean_centred_MSE_loss
    ...
    for i, dataset in enumerate(datasets):
        ...
        try:
            ...
            _, opt_result = run_optimise(
                ...
                forward_models=models,
                indexes=[0, 0],
                loss_functions=[hdx_uptake_mean_centred_MSE_loss, frame_weight_consistency_loss],
            )
...
if __name__ == "__main__":
    ...
    regularisation_scales = [0, 1e-3, 1e-2, 1e-1, 1e0, 1e1, 1e2, 1e3]
    regularisation_scales = [1e-5, 1e-4, 1e-6]
