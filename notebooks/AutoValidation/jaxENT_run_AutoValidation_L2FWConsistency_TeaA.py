...
def run_quick_auto_validation(
    ...
    new_params = Simulation_Parameters(
        ...
        forward_model_weights=jnp.array([10, 100, regularisation_scale], dtype=jnp.float32),
...
if __name__ == "__main__":
    ...
    regularisation_scales = [0, 1.0, 2.0, 5.0, 10.0, 20.0, 50.0, 100.0]
