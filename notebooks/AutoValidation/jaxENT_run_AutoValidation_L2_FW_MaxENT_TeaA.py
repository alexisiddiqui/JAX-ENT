...
def run_quick_auto_validation(
    ...
    new_params = Simulation_Parameters(
        ...
        model_parameters=[bv_config.forward_parameters],
        forward_model_weights=jnp.array([1.0, 100.0, regularisation_scale], dtype=jnp.float32),
...
if __name__ == "__main__":
    ...
    regularisation_scale = [0, 0.01, 0.1, 1.0, 10.0, 100.0, 1000.0][2]
    # regularisation_scale = 10.0
    base_output_dir = os.path.join(
        os.path.dirname(__file__),
        "normalisation_exp_MaxENT",
