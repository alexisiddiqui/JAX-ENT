...
from jaxent.src.opt.losses import frame_weight_consistency_loss, hdx_uptake_l2_loss
...
def run_quick_auto_validation(
    ...
    new_params = Simulation_Parameters(
        ...
        forward_model_weights=jnp.array([regularisation_scale, 1.0], dtype=jnp.float32),
...
if __name__ == "__main__":
    ...
    regularisation_scales = [0.1, 1.0, 10.0, 100.0]
