...
def calculate_reweighted_ss_distribution(ss_data, weights_dict):
    ...
    # Define histogram bins (0-100% in steps of 2%)
    ...
    for method, param_dict in weights_dict.items():
        ...
        for param, seed_dict in param_dict.items():
            ...
            for seed_key, weights in seed_dict.items():
                ...
                # Ensure weights is a float NumPy array
                weights = np.asarray(weights, dtype=float)

                # check for nan values and replace with uniform if any
            ...
            for seed_idx in range(1, n_seeds + 1):
                ...
                try:
                    ...
                    weights_file = os.path.join(
                        hdxer_dir,
                        f"train_MoPrP_af_dirty_{seed_idx}",
...
def plot_boxplots(results, metric_name, method_names=None, title=None, ylabel=None):
    ...
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])  # Adjust rect slightly for labels
...
def main():
    # Base directory containing results
    base_dir = "/home/alexi/Documents/JAX-ENT/notebooks/CrossValidation/MoPrP/jaxENT/unfiltered_AdamW_loreg_conv1e-8_MAD5"
    ...
    # HDXer directory
    hdxer_dir = "/home/alexi/Documents/JAX-ENT/notebooks/CrossValidation/MoPrP/HDXer/unflltered/data/MoPrP_af_dirty/Benchmark/RW_bench/MoPrP_af_dirty_RW_bench_r_naive_random"
