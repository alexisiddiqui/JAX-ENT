#!/usr/bin/env python3
"""Mixed-linear-model analysis wrapper for 4_aSyn model scores."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyse 4_aSyn mixed linear model score metrics")
    parser.add_argument("--scores-csv-path", default="../fitting/_scores/model_scores.csv")
