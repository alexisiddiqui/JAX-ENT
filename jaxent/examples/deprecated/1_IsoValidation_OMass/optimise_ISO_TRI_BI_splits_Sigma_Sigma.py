...
from optimise_fn import run_optimise_ISO_TRI_BI_maxENT_MAE_Sigma_Sigma
...
def run_maxent_sweep(
    ...
    cov_matrix_data = jnp.load(os.path.join(os.path.dirname(__file__), cov_matrix_path))["Sigma_inv"] 


    # Load prior dataset
    cov_prior_path = f"_covariance_matrices_sigma/{ensemble}_Sigma_weighted.npz"

    prior_cov_matrix_data = jnp.load(os.path.join(os.path.dirname(__file__), cov_prior_path))["Sigma_inv"] 



    prior_dataset = ExpD_Dataloader(data=prior_HDX, covariance_matrix=prior_cov_matrix_data)
    ...
    for split_type in split_types:
        ...
        for split_idx, (train_data, val_data) in enumerate(splits):
            ...
            for maxent_value in maxent_values:
                ...
                try:
                    run_optimise_ISO_TRI_BI_maxENT_MAE_Sigma_Sigma(
