"""
[Script Name] analyse_split_CrossVal.py

[Brief Description of Functionality]
Visualizes and analyzes the data splits generated by `splitdata_CrossVal.py`.
It produces:
1. Heatmaps showing peptide coverage and gaps for each split.
2. Heatmaps of uptake curves for training vs. validation sets.
3. Distribution plots of the number of splits across replicates.

Requirements:
    - `_datasplits/` directory containing split data (generated by `splitdata_CrossVal.py`).
    - `jaxent` library.
...
Output:
    - Plots saved in `jaxent/examples/2_CrossValidation/analysis/_analysis_split_CrossVal/`.
"""
