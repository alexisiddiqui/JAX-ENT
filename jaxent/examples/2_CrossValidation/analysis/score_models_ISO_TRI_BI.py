"""
score_models_ISO_TRI_BI.py  (Exp2 — CrossValidation)
...
Usage:
    python jaxent/examples/2_CrossValidation/analysis/score_models_ISO_TRI_BI.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="Calculate scores and metrics from processed Exp2 optimization results."
    )
    parser.add_argument(
        "--processed-data-dir",
