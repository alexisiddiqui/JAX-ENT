#!/usr/bin/env python3
"""Thin wrapper for mixed linear model score analysis (Experiment 2)."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyse mixed linear model score metrics (Experiment 2).")
    parser.add_argument(
        "--scores-csv-path",
