"""
This script anlyzes the features distributions relevant for clustering the trajectory provided into folded, PUF1, PUF2 and unfolded states.
...
- PCA of features
- PCA of pairwise coordinates, annotated by clusters

The features are then clusterd to 4 clusters using KMeans clustering and the clusters are visualized in PCA space using pairwise coordinates.

Input Args:
- topology: Path to the reference topology file (PDB format)
- trajectory: Path to the trajectory file (xtc format)
...
# Feature selection options (default: all features):
- helices: list of floats: 1,2,3 - default: all
- strands: list of floats: 1,2 - default: all


/home/alexi/Documents/JAX-ENT/jaxent/examples/2_CrossValidation/data/MoPrP_max_plddt_4334.pdb
/home/alexi/Documents/JAX-ENT/jaxent/examples/2_CrossValidation/data/_cluster_MoPrP_filtered/clusters/all_clusters.xtc

python jaxent/examples/2_CrossValidation/analysis/analyse_cluster_LocalFeatures_PUFs.py --topology_path /home/alexi/Documents/JAX-ENT/jaxent/examples/2_CrossValidation/data/MoPrP_max_plddt_4334.pdb --trajectory_paths /home/alexi/Documents/JAX-ENT/jaxent/examples/2_CrossValidation/data/_cluster_MoPrP_filtered/clusters/all_clusters.xtc --n_clusters 4 --output_dir /home/alexi/Documents/JAX-ENT/jaxent/examples/2_CrossValidation/analysis/_MoPrP_analysis_clusters4 --save_pdbs --secondary_structure
...
def parse_arguments():
    ...
    # Add feature selection help
    parser.epilog = (
        "Feature selection examples:\n"
        "  --all_features                  Calculate all available features (default)\n"
        "  --rmsd --rog                    Calculate only RMSD and radius of gyration\n"
        "  --rmsd --sasa --native_contacts Calculate RMSD, SASA, and native contacts\n"
        "  --region_features               Calculate region-specific dihedral and COM features (requires JSON file)\n"
    )
...
if __name__ == "__main__":
    import sys  # Make sure we have sys imported at the top of the file
