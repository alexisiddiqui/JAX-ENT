...
ANA_DIR="analysis"
DIR_WD="fitting/jaxENT"
# Example optimization output directory - CHANGE THIS to matches your actual output
OPT_OUTPUT_DIR="${DIR_WD}/_optimise_quick_test_splits__20250918_171508" 
...
python "${ANA_DIR}/process_optimisation_results.py" \
  ...
  --clustering-dir "analysis/_MoPrP_analysis_clusters_feature_spec_AF2_test/clusters" \
...
python "${ANA_DIR}/score_models_ISO_TRI_BI.py" \
  ...
  --features-dir "${DIR_WD}/_featurise" \
  --clustering-dir "analysis/_MoPrP_analysis_clusters_feature_spec_AF2_test/clusters" \
  --state-ratios-json "$(pwd)/analysis/state_ratios.json" \
