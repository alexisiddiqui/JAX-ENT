#!/usr/bin/env python3
"""Selected-model analysis plots for HDXer reweighting results — Example 3.
...
def main() -> None:
    p = argparse.ArgumentParser(description="Plot HDXer selected-model summaries for Example 3.")
    p.add_argument(
        "--weights-dir",
        default=None,
        help="Directory containing per-replicate HDXer weight NPZ files. "
             "Defaults to the Example 3 HDXer output path.",
    )
