"""
Plot Selected MoPrP Models and Performance

Function:
Visualizes the results of the model selection and linear modeling analysis:
- Recovery Score vs. Metrics across ensembles and splits.
- Statistical significance plots comparing ensemble performance.
- Direct comparisons before and after convergence filtering.
- Performance vs. Inconsistency scatter plots and bar charts.

Requirements:
- Loads `model_selection_performance_summary.csv` generated by `analyse_scores_mixed_linear_model.py`.
"""
