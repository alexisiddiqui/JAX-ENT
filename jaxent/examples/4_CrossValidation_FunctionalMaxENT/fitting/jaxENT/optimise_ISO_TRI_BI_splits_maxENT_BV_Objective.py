...
def run_maxent_sweep(
    ...
    # Setup BV model
    bv_config = BV_model_Config(num_timepoints=0)
    ...
    cov_matrix_path = "../../../2_CrossValidation/data/_MoPrP_covariance_matrices/Sigma.npz"
