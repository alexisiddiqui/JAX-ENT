...
def run_optimise_ISO_TRI_BI(
    ...
    _, optimizer = optimise_sweep(
        _simulation=sim,
        data_to_fit=(data_to_fit, pairwise_similarity),  # Added pairwise_similarity
        n_steps=n_steps,
        tolerance=1e-10,
...
def main():
    ...
    bi_modal_traj_file = os.path.join(base_traj_dir, "sliced_trajectories/TeaA_initial_sliced.xtc")
