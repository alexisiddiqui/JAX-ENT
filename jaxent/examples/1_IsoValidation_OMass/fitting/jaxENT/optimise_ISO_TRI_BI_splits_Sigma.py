"""
optimise_ISO_TRI_BI_splits_Sigma.py

Runs the core optimization loop for ISO/TRI/BI ensembles using Sigma (covariance) matrices.
...
Requirements:
    - Split data (_datasplits/)
    - Sigma matrices (_covariance_matrices_sigma/)
    - Features (_featurise/)

Usage:
    python jaxent/examples/1_IsoValidation_OMass/fitting/jaxENT/optimise_ISO_TRI_BI_splits_Sigma.py [args]

Output:
    - Optimization history HDF5 files (e.g., results_EMA.hdf5) in _optimise_.../
"""
