...
def main():
    ...
    loss_functions = ["mcMSE", "MSE", "Sigma_MSE"] # Include Sigma_MSE as it's in the optimise script
    num_splits = 3 # This is used for loading optimization results, not for data splits here
