#!/usr/bin/env python3
"""
Analyze optimization loss landscapes for ISO_TRI and ISO_BI models.

REFACTORED: Reduced from 2131 lines to ~160 by using jaxent.examples.common modules.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze optimization loss landscapes for ISO_TRI and ISO_BI models"
    )
    parser.add_argument(
        "--config",
        default="config.yaml",
    ...
    print("=" * 80)
    print("EXPERIMENT 1: ISO_TRI / ISO_BI Loss Landscape Analysis (REFACTORED)")
    print("=" * 80)
