...
from jaxent.config.base import Optimisable_Parameters
...
from jaxent.optimise.base import (
...
from jaxent.types.base import Output_Features
...
class OptaxOptimizer:
    def __init__(
        ...
        parameter_masks: set[Optimisable_Parameters] = {
            Optimisable_Parameters(0),
            Optimisable_Parameters.forward_model_weights,
        },
