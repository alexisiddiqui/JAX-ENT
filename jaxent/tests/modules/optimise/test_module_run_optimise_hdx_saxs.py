...
def test_module_run_optimise_hdx_saxs_reduces_loss_and_exposes_keyed_outputs():
    ...
    optimised_simulation, history = run_optimise(
        ...
        config=make_test_optimiser_settings("module_hdx_saxs"),
    ...
    assert_output_keys(
        ...
        expected_keys=[m_key("HDX_resPF"), m_key("SAXS_Iq")],
    )
