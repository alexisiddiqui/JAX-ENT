...
from jaxent.src.models.SAXS.features import SAXS_reweighted_input_features
...
class SAXS_model(ForwardModel[SAXS_Reweighted_Parameters, SAXS_reweighted_input_features, SAXS_Config]):
    ...
    (e.g. CRYSOL, FoXS, Pepsi-SAXS) and passed as SAXS_reweighted_input_features
    ...
    def featurise(self, ensemble: list):
        raise NotImplementedError(
            ...
            "Create SAXS_reweighted_input_features or SAXS_basis_input_features directly."
        )
