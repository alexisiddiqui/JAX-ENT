...
def test_quick_optimiser():
    ...
    configurations = [
        {"name": "adam_default", "optimizer": "adam", "learning_rate": 1e-4, "n_steps": 200},
        {"name": "adam_fast", "optimizer": "adam", "learning_rate": 5e-4, "n_steps": 200},
        {"name": "sgd_default", "optimizer": "sgd", "learning_rate": 1e-3, "n_steps": 200},
    ]
    ...
    best_opt_settings = OptimiserSettings(
        ...
        convergence=1e-10,  # hopefully this will make the optimization run until the end
    )
