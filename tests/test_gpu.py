...
def test_gpu_info():
    ...
    print(f"GPU information retrieved successfully. Device kind: {device.device_kind}, Platform: {device.platform}")
...
def test_gpu_performance():
    ...
    num_iterations = 1000  # Number of iterations for the test
